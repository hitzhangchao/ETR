...
R_g0 = R_temp;
p_s_g0 = p_s(:,end);
T0_g0 = [R_g0,p_s_g0;[0 0 0 1]];



%% sheath级运动学 - 各管
T1_g1_g0 = [eye(3),p11_0;[0 0 0 1]];        % arm1 s=0起始点global{1}系相对于global{0}系
T2_g2_g0 = [eye(3),p21_0;[0 0 0 1]];        % arm2 s=0起始点global{2}系相对于global{0}系
T3_g3_g0 = [eye(3),p31_0;[0 0 0 1]];        % arm3 s=0起始点global{3}系相对于global{0}系
...
R1_g1 = R_temp;     %末端相对于管global{1}系的旋转矩阵（FS Frame）
p_11_g0 = p_11(:,end);
T11_g0 = [R1_g1,p_11_g0;[0 0 0 1]];
...
hold on
% tube 21末端相对于global{0}系位姿
R2_g2 = R_temp;     %末端相对于管global{2}系的旋转矩阵（FS Frame）
p_21_g0 = p_21(:,end);
T21_g0 = [R2_g2,p_21_g0;[0 0 0 1]];
...
hold on
% tube 31末端相对于global{0}系位姿
R3_g3 = R_temp;     %末端相对于管global{3}系的旋转矩阵（FS Frame）
p_31_g0 = p_31(:,end);
T31_g0 = [R3_g3,p_31_g0;[0 0 0 1]];
...
% T0_g0 —— sheath末端相对于global{0}系
% T11_g0 —— sheath级tube 1末端相对于global{0}系
% T21_g0 —— sheath级tube 2末端相对于global{0}系
% T31_g0 —— sheath级tube 3末端相对于global{0}系
